...
const WALLET_ADDRESS = "0x4abD06E6012BfA6260554Cef6C37a62117288C94";
/**
...
function Login() {
    ...
    const getBalance = async (wallet_address: string) => {
        const TOKEN_ADDRESS = "0xb2ea51BAa12C461327d12A2069d47b30e680b69D";
        ...
        const balance: number = await tokenContract.methods.balanceOf(wallet_address).call();
    ...
    const { data: walletBalance, isLoading, isError, error : getBalanceError } = useQuery(
                        ...
                        <div className={` ${isMobileDevice ? 'w-full mt-4' : 'w-1/3 mt-10' }`}>
                            ...
                            <div className={`flex flex-col mr-2 ${isMobileDevice ? "mt-6 mr-0" : 'mt-10'}`}>
                                ...
                                <IonButton className='buy-nft-btn mt-4 h-11'color='medium' onClick={()=> window.open('https://magiceden.io/marketplace/soldecoder', "_blank")}>
                                    ...
                                    {walletBalance ? walletBalance : "Buy 1 NFT to gain access"}
                                </IonButton>
